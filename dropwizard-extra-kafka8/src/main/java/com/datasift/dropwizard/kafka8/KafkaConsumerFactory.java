...
import com.datasift.dropwizard.kafka8.consumer.KafkaConsumer;
import com.datasift.dropwizard.kafka8.consumer.StreamProcessor;
import io.dropwizard.util.Duration;
import io.dropwizard.util.Size;
import com.datasift.dropwizard.kafka8.consumer.KafkaConsumerHealthCheck;
...
public class KafkaConsumerFactory extends KafkaClientFactory {
    ...
    public class KafkaConsumerBuilder<K, V> {
         ...
         */
        public SynchronousConsumer<K, V> build(final ScheduledExecutorService executor) {
